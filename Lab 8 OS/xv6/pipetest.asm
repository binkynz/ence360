  ...
  13:	8d 85 d8 fd ff ff    	lea    -0x228(%ebp),%eax
{
  ...
  1a:	81 ec 28 02 00 00    	sub    $0x228,%esp
    pipe(pr);
  20:	50                   	push   %eax
  21:	e8 dd 03 00 00       	call   403 <pipe>
    pipe(pw);
  26:	8d 85 e0 fd ff ff    	lea    -0x220(%ebp),%eax
  2c:	89 04 24             	mov    %eax,(%esp)
  2f:	e8 cf 03 00 00       	call   403 <pipe>

    int stdout = dup(0);
  34:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3b:	e8 2b 04 00 00       	call   46b <dup>
  40:	89 c3                	mov    %eax,%ebx

    if (!fork())
  42:	e8 a4 03 00 00       	call   3eb <fork>
  ...
  55:	6a 00                	push   $0x0
  57:	e8 bf 03 00 00       	call   41b <close>
        dup(pr[0]);
  5c:	58                   	pop    %eax
  5d:	ff b5 d8 fd ff ff    	pushl  -0x228(%ebp)
  63:	e8 03 04 00 00       	call   46b <dup>
        close(1); // stdout
  68:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  6f:	e8 a7 03 00 00       	call   41b <close>
        dup(pw[1]);
  74:	58                   	pop    %eax
  75:	ff b5 e4 fd ff ff    	pushl  -0x21c(%ebp)
  7b:	e8 eb 03 00 00       	call   46b <dup>

        close(pr[0]);
  80:	58                   	pop    %eax
  81:	ff b5 d8 fd ff ff    	pushl  -0x228(%ebp)
  87:	e8 8f 03 00 00       	call   41b <close>
        close(pr[1]);
  8c:	5a                   	pop    %edx
  8d:	ff b5 dc fd ff ff    	pushl  -0x224(%ebp)
  93:	e8 83 03 00 00       	call   41b <close>
        close(pw[0]);
  98:	59                   	pop    %ecx
  99:	ff b5 e0 fd ff ff    	pushl  -0x220(%ebp)
  9f:	e8 77 03 00 00       	call   41b <close>
        close(pw[1]);
  a4:	5b                   	pop    %ebx
  a5:	ff b5 e4 fd ff ff    	pushl  -0x21c(%ebp)
  ab:	e8 6b 03 00 00       	call   41b <close>

        char *argv[] = {"wc", NULL};
        exec("wc", argv);
  b0:	5e                   	pop    %esi
  b1:	58                   	pop    %eax
  b2:	8d 85 e8 fd ff ff    	lea    -0x218(%ebp),%eax
  b8:	50                   	push   %eax
  b9:	68 b8 08 00 00       	push   $0x8b8
        char *argv[] = {"wc", NULL};
  be:	c7 85 e8 fd ff ff b8 	movl   $0x8b8,-0x218(%ebp)
  c5:	08 00 00 
  c8:	c7 85 ec fd ff ff 00 	movl   $0x0,-0x214(%ebp)
  cf:	00 00 00 
        exec("wc", argv);
  d2:	e8 54 03 00 00       	call   42b <exec>
  d7:	83 c4 10             	add    $0x10,%esp
    ...
    exit();
  da:	e8 14 03 00 00       	call   3f3 <exit>
        close(pr[0]);
  df:	83 ec 0c             	sub    $0xc,%esp
  e2:	ff b5 d8 fd ff ff    	pushl  -0x228(%ebp)
  e8:	e8 2e 03 00 00       	call   41b <close>
        write(pr[1], "hello world\n", 12);
  ed:	83 c4 0c             	add    $0xc,%esp
  f0:	6a 0c                	push   $0xc
  f2:	68 bb 08 00 00       	push   $0x8bb
  f7:	ff b5 dc fd ff ff    	pushl  -0x224(%ebp)
  fd:	e8 11 03 00 00       	call   413 <write>
        close(pr[1]);
 102:	59                   	pop    %ecx
 103:	ff b5 dc fd ff ff    	pushl  -0x224(%ebp)
 109:	e8 0d 03 00 00       	call   41b <close>
        wait();
 10e:	e8 e8 02 00 00       	call   3fb <wait>
        printf(stdout, "recieved:\n");
 113:	5e                   	pop    %esi
 114:	58                   	pop    %eax
 115:	68 c8 08 00 00       	push   $0x8c8
 11a:	53                   	push   %ebx
 11b:	8d b5 e8 fd ff ff    	lea    -0x218(%ebp),%esi
 121:	e8 2a 04 00 00       	call   550 <printf>
        close(pw[1]);
 126:	58                   	pop    %eax
 127:	ff b5 e4 fd ff ff    	pushl  -0x21c(%ebp)
 12d:	e8 e9 02 00 00       	call   41b <close>
        while ((n = read(pw[0], buf, sizeof(buf))) > 0)
 132:	83 c4 10             	add    $0x10,%esp
 135:	eb 24                	jmp    15b <main+0x15b>
 137:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 13e:	66 90                	xchg   %ax,%ax
            printf(stdout, "%d\n", n);
 140:	83 ec 04             	sub    $0x4,%esp
 143:	50                   	push   %eax
 144:	68 d3 08 00 00       	push   $0x8d3
 149:	53                   	push   %ebx
 ...
 151:	56                   	push   %esi
 152:	53                   	push   %ebx
 153:	e8 f8 03 00 00       	call   550 <printf>
 158:	83 c4 10             	add    $0x10,%esp
        while ((n = read(pw[0], buf, sizeof(buf))) > 0)
 15b:	83 ec 04             	sub    $0x4,%esp
 15e:	68 00 02 00 00       	push   $0x200
 163:	56                   	push   %esi
 164:	ff b5 e0 fd ff ff    	pushl  -0x220(%ebp)
 16a:	e8 9c 02 00 00       	call   40b <read>
 16f:	83 c4 10             	add    $0x10,%esp
 172:	85 c0                	test   %eax,%eax
 174:	7f ca                	jg     140 <main+0x140>
        close(pw[0]);
 176:	83 ec 0c             	sub    $0xc,%esp
 179:	ff b5 e0 fd ff ff    	pushl  -0x220(%ebp)
 17f:	e8 97 02 00 00       	call   41b <close>
 184:	83 c4 10             	add    $0x10,%esp
 187:	e9 4e ff ff ff       	jmp    da <main+0xda>
...
printf(int fd, const char *fmt, ...)
{
 ...
 6d4:	eb 1a                	jmp    6f0 <printf+0x1a0>
          s = "(null)";
 6d6:	bb d7 08 00 00       	mov    $0x8d7,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 725:	a1 90 0b 00 00       	mov    0xb90,%eax
{
 ...
 746:	73 10                	jae    758 <free+0x38>
{
 ...
 771:	5b                   	pop    %ebx
  freep = p;
 772:	a3 90 0b 00 00       	mov    %eax,0xb90
}
 777:	5e                   	pop    %esi
 778:	5f                   	pop    %edi
 779:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 7bd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7c0:	8b 3d 90 0b 00 00    	mov    0xb90,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 809:	8b 3d 90 0b 00 00    	mov    0xb90,%edi
 ...
 832:	e8 e9 fe ff ff       	call   720 <free>
  return freep;
 837:	a1 90 0b 00 00       	mov    0xb90,%eax
 ...
 864:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 867:	a3 90 0b 00 00       	mov    %eax,0xb90
}
 ...
 87e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 880:	c7 05 90 0b 00 00 94 	movl   $0xb94,0xb90
 887:	0b 00 00 
    base.s.size = 0;
 88a:	bf 94 0b 00 00       	mov    $0xb94,%edi
    base.s.ptr = freep = prevp = &base;
 88f:	c7 05 94 0b 00 00 94 	movl   $0xb94,0xb94
 896:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 899:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 89b:	c7 05 98 0b 00 00 00 	movl   $0x0,0xb98
 8a2:	00 00 00 
    if(p->s.size >= nunits){
