  ...
  18:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  20:	50                   	push   %eax
  21:	50                   	push   %eax
  22:	68 f8 07 00 00       	push   $0x7f8
  27:	6a 01                	push   $0x1
  29:	e8 62 04 00 00       	call   490 <printf>
        exit();
  2e:	e8 00 03 00 00       	call   333 <exit>
    }
  ...
  3a:	e8 34 03 00 00       	call   373 <open>
  ...
  40:	89 c6                	mov    %eax,%esi
    int dest_fd = open(argv[2], O_CREATE | O_RDWR);
  42:	58                   	pop    %eax
  43:	68 02 02 00 00       	push   $0x202
  48:	ff 73 08             	pushl  0x8(%ebx)
  4b:	e8 23 03 00 00       	call   373 <open>
  ...
  69:	57                   	push   %edi
  6a:	e8 e4 02 00 00       	call   353 <write>
  6f:	83 c4 10             	add    $0x10,%esp
  72:	39 d8                	cmp    %ebx,%eax
  74:	75 31                	jne    a7 <main+0xa7>
    while ((n = read(src_fd, buf, sizeof(buf))) > 0)
  76:	83 ec 04             	sub    $0x4,%esp
  79:	68 00 02 00 00       	push   $0x200
  7e:	68 20 0b 00 00       	push   $0xb20
  83:	56                   	push   %esi
  84:	e8 c2 02 00 00       	call   34b <read>
  89:	83 c4 10             	add    $0x10,%esp
  8c:	89 c3                	mov    %eax,%ebx
  8e:	85 c0                	test   %eax,%eax
  90:	7f ce                	jg     60 <main+0x60>
    ...
    if (n < 0)
  92:	74 26                	je     ba <main+0xba>
    {
        printf(1, "cp: read error\n");
  94:	50                   	push   %eax
  95:	50                   	push   %eax
  96:	68 27 08 00 00       	push   $0x827
  9b:	6a 01                	push   $0x1
  9d:	e8 ee 03 00 00       	call   490 <printf>
        exit();
  a2:	e8 8c 02 00 00       	call   333 <exit>
            printf(1, "cp: write error\n");
  a7:	52                   	push   %edx
  a8:	52                   	push   %edx
  a9:	68 16 08 00 00       	push   $0x816
  ae:	6a 01                	push   $0x1
  b0:	e8 db 03 00 00       	call   490 <printf>
            exit();
  b5:	e8 79 02 00 00       	call   333 <exit>
    }

    close(src_fd);
  ba:	83 ec 0c             	sub    $0xc,%esp
  bd:	56                   	push   %esi
  be:	e8 98 02 00 00       	call   35b <close>
    close(dest_fd);
  c3:	89 3c 24             	mov    %edi,(%esp)
  c6:	e8 90 02 00 00       	call   35b <close>
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	eb 1a                	jmp    630 <printf+0x1a0>
          s = "(null)";
 616:	bb 37 08 00 00       	mov    $0x837,%ebx
        while(*s != 0){
