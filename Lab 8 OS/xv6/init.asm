...
int main(void)
{
  ...
  int one = dup(0); // stdout
  2d:	83 ec 0c             	sub    $0xc,%esp
  30:	6a 00                	push   $0x0
  32:	e8 a4 03 00 00       	call   3db <dup>
  int two = dup(0); // stderr
  37:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  int one = dup(0); // stdout
  3e:	89 c3                	mov    %eax,%ebx
  int two = dup(0); // stderr
  40:	e8 96 03 00 00       	call   3db <dup>

  printf(1, "%d %d\n", one, two);
  45:	50                   	push   %eax
  46:	53                   	push   %ebx
  47:	68 30 08 00 00       	push   $0x830
  4c:	6a 01                	push   $0x1
  ...
  b4:	50                   	push   %eax
  b5:	50                   	push   %eax
  b6:	68 34 0b 00 00       	push   $0xb34
  bb:	68 5d 08 00 00       	push   $0x85d
  c0:	e8 d6 02 00 00       	call   39b <exec>
      printf(1, "init: exec sh failed\n");
  c5:	5a                   	pop    %edx
  c6:	59                   	pop    %ecx
  c7:	68 60 08 00 00       	push   $0x860
  cc:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	eb 1a                	jmp    660 <printf+0x1a0>
          s = "(null)";
 646:	bb 7f 08 00 00       	mov    $0x87f,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 695:	a1 3c 0b 00 00       	mov    0xb3c,%eax
{
...
malloc(uint nbytes)
{
 ...
 72d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 730:	8b 3d 3c 0b 00 00    	mov    0xb3c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7a2:	e8 e9 fe ff ff       	call   690 <free>
  return freep;
 7a7:	a1 3c 0b 00 00       	mov    0xb3c,%eax
